...
2. ai@7.0.0-canary.127
   ...
   BUILDER IMPACT: Breaking change — check if your dependencies are affected.
...
3. v0.9.3
   ...
   BUILDER IMPACT: General AI signal — evaluate relevance to your stack.
...
5. Using Claude Code: The Unreasonable Effectiveness of HTML
   ...
   BUILDER IMPACT: Updates to claude code — directly affects your local dev workflow.
...
### Patch Changes - Updated dependencies [c261259] - @ai-sdk/gateway@2.0.88 Security update — check if you're running affected versions. Highly actionable — concrete steps available.
